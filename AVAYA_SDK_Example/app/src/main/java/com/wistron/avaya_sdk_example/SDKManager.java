...
public class SDKManager implements UserRegistrationListener, ClientListener, CredentialProvider, CallServiceListener, CallListener {
    ...
    //If you are connecting to IPO deployment, change this value to true.
    ...
    private void setupIPOSpecificConfiguration() {
        ...
        //Set IPO configuration as below to use IPO services
        IPOfficeConfiguration ipoconfiguration = userConfiguration.getIPOfficeConfiguration();
        ipoconfiguration.setEnabled(true);
        ipoconfiguration.setContactsEnabled(true);
        ipoconfiguration.setPresenceEnabled(true);

        // Using SIP credential provider. You can use SIP credential provider for IPO if you have
        // same login details. Please create another credential provider in case IPO authentication
        // details are different from SIP user configuration details.
        ipoconfiguration.setCredentialProvider(this);

        userConfiguration.setIPOfficeConfiguration(ipoconfiguration);
    }
